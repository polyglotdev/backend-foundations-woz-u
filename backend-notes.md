# Backend Foundations with JavaScript
...
--
![Back-End 🛠 ]('https://raw.githubusercontent.com/CodefulDom/backend-foundations-woz-u/blob/master/backend-foundations/backend-architecture.png?sanitize=true&raw=true)
